                ...
                @forelse($items as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('items.edit', $item->id) }}" class="text-blue-600 hover:underline mr-3">Edit</a>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-400">
                            Belum ada item. <a href="{{ route('items.create') }}" class="text-blue-600 hover:underline">Tambah
                                sekarang</a>
                        </td>
                    </tr>
                @endforelse
