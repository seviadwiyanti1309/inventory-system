...
<div class="max-w-xl mx-auto">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Edit Kategori: {{ $category->name }}</h1>
        <p class="text-gray-500 text-sm italic mt-1">Perbarui nama kategori atau konfigurasi di bawah ini.</p>
    </div>
